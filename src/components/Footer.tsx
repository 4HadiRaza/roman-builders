...
export default function Footer() {
  return (
    <footer className="relative bg-[#2a3226] text-white">

      {/* Wave Divider — wrapper bg matches page so transparent SVG top looks correct */}
      <div className="bg-[#e8e4db] leading-[0] -mb-px">
        <svg
        ...
        >
          {/* Layer 1 (back) – beige: fills from its wave DOWN */}
          <path
          ...
          <path
            ...
            fill="#505A45"
          />
          {/* Layer 3 (front) – dark green: merges with footer bg */}
          <path
      ...
      <div className="relative z-10 max-w-[90rem] mx-auto px-6 lg:px-8 xl:px-12 pt-10 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-0 items-center">
          ...
          <div className="flex flex-col justify-center lg:pr-10 xl:pr-14">
            ...
            <div className="relative flex items-center bg-[#f0ece3] rounded-full p-1 mb-3 shadow-md max-w-[320px] border border-[#d4cfc5]/50">
        ...
        <div className="mt-14 pt-5 border-t border-white/10 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-4 pb-2">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-[10px] sm:text-[11px] text-white/60 font-medium">
            ...
            <span className="text-white/20">|</span>
            <a href="#process" className="hover:text-white transition-colors">Services</a>
            <span className="text-white/20">|</span>
            <a href="#news" className="hover:text-white transition-colors">Blog</a>
            <span className="text-white/20">|</span>
